...
% 请在以下的方括号中填写队伍控制号
\usepackage[2612849]{easymcm}  % 载入 EasyMCM 模板文件
\problem{\textcolor{red}{A}}  % 请在此处填写题号

% 仅修改 Summary Sheet 上的控制号颜色为红色，页眉保持黑色
\makeatletter
\patchcmd{\makesheet}{\MCM@control}{\textcolor{red}{\MCM@control}}{}{}
\makeatother
...
% 插入两页空白，用于conclusion和references之间的间隔
%将这两页替换成你们的学术海报或者彩页
\clearpage
\thispagestyle{empty}
\mbox{}
